        ...
        if ( ! empty( $comments_by_type['comment'] ) ) : ?>
            ...
            if ( $total_pages > 1 ) : ?>
                <div id="comments-nav-above" class="comments-navigation">
                    <div class="paginated-comments-links clearfix"><?php paginate_comments_links( array(
                            'type'      => 'list',
                            'prev_text' => __( '<i class="ss-navigateleft"></i> Previous', 'swiftframework' ),
                            'next_text' => __( 'Next <i class="ss-navigateright"></i>', 'swiftframework' )
                        ) ); ?></div>
            ...
            if ( $total_pages > 1 ) : ?>
                <div id="comments-nav-below" class="comments-navigation">
                    <div
                        class="paginated-comments-links comments-links-after clearfix"><?php paginate_comments_links( array(
                            'type'      => 'list',
                            'prev_text' => __( '<i class="ss-navigateleft"></i> Previous', 'swiftframework' ),
                            'next_text' => __( 'Next <i class="ss-navigateright"></i>', 'swiftframework' )
                        ) ); ?></div>
