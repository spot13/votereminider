...
jQuery(document).ready(function(){
	...
	jQuery("#sf_uplift_options-colour_scheme_select_scheme").find('select').val("default").trigger('change');
            ...
            if ( attachment.attributes.url ) {
			    ...
			    jQuery.ajax({
			           ...
			           success:function(results) {
				         	jQuery("#sf_uplift_options-colour_scheme_select_scheme").find('select').select2('destroy');
				         	jQuery("#sf_uplift_options-colour_scheme_select_scheme").find('select').replaceWith(results);
				         	jQuery("#sf_uplift_options-colour_scheme_select_scheme").find('select').select2(default_params);
				         	jQuery("#import-schema-message").show();
						    jQuery("#sf_uplift_options-colour_scheme_select_scheme").change( function( event ) {
    ...
    jQuery("a.use-this-scheme").click( function( event ) {
        ...
        var selected = jQuery("#sf_uplift_options-colour_scheme_select_scheme").find('select').val();
		    ...
		    jQuery.ajax({
		           ...
		           success:function(results) {
				        if ( results == "success" ) {
					        ...
					        // move the select box back to default
					        jQuery("#sf_uplift_options-colour_scheme_select_scheme option[value='" + selected + "']").remove();
	...
	function updateSchemaHTML ( selected ) {
	    jQuery.ajax({
	           ...
	           success:function(results) {
		           jQuery("#sf_uplift_options-color-list").replaceWith(results);
