    ...
    class ReduxFramework_custom_fonts {
        ...
        public function render () {
            ...
            if ( !empty ( $this->field[ 'custom_fonts' ] ) ) {
                foreach ( $this->field[ 'custom_fonts' ] as $section => $fonts ) {
                    ...
                    echo '<div class="upload_button_div"><span class="button media_add_font" data-nonce="' . $nonce . '" id="' . $this->field[ 'id' ] . '-custom_fonts">' . __ ( 'Add Font', 'uplift' ) . '</span></div><br />';
                }
            } else {
                echo "<h3>" . __ ( 'No Custom Fonts Found', 'uplift' ) . "</h3>";
                echo '<div class="upload_button_div"><span class="button media_add_font" data-nonce="' . $nonce . '" id="' . $this->field[ 'id' ] . '-custom_fonts">' . __ ( 'Add Font', 'uplift' ) . '</span></div>';
            }
        ...
        public function enqueue () {
            ...
            wp_localize_script( 'redux-field-custom_fonts-js', 'redux_custom_fonts_l10', apply_filters( 'redux_custom_fonts_localized_data', array(
                ...
                'media_title'   => __('Choose font file or ZIP of font files.', 'uplift'),
