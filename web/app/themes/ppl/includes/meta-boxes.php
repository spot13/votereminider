	...
	function sf_register_meta_boxes() {
	    ...
	    $meta_boxes[] = array(
	        ...
	        'fields'  => array(
	            ...
	            array(
	                'name' => __( 'Thumbnail Background Hover Color', 'swiftframework' ),
	    ...
	    $meta_boxes[] = array(
	        ...
	        'fields'  => array(
	            ...
	            array(
	                ...
	                'desc' => __( "Enter a custom page title if you'd like (Fancy Page Title Style Only).", 'swiftframework' ),
	                'type' => 'text',
	                'std'  => '',
	            ),
	            // PAGE TITLE BACKGROUND COLOR
	            array(
	                'name' => __( 'Background Color', 'swiftframework' ),
	                'id'   => "{$prefix}bg_color_title",
	                'desc' => __( "Set a background color for this slide. If an image is uploaded, this will serve as the overlay color as well.", 'swiftframework' ),
	                'type' => 'color',
	                'std'  => '',
	            ),
	            ...
	            array(
	                'name'             => __( 'Fancy Heading Background Image', 'swiftframework' ),
	                'desc'             => __( 'The image that will be used as the background for the fancy header.', 'swiftframework' ),
	            ...
	            array(
	                'name'     => __( 'Fancy Heading Text Style', 'swiftframework' ),
	            ...
	            array(
	                'name'     => __( 'Fancy Heading Text Align', 'swiftframework' ),
	                ...
	                'multiple' => false,
	                'std'      => 'left',
	                'desc'     => __( 'Choose the text alignment for the fancy header.', 'swiftframework' )
	            ),
	            // FANCY HEADING HEIGHT
	            array(
	                'name'  => __( 'Fancy Heading Height', 'swiftframework' ),
	                'id'    => "{$prefix}page_title_height",
	                'desc'  => __( "Set the height for the Fancy Heading (no px).", 'swiftframework' ),
	                'clone' => false,
	                'type'  => 'text',
	                'std'   => '400',
	            ),
	    ...
	    $meta_boxes[] = array(
	        ...
	        'fields'  => array(
	            ...
	            array(
	                ...
	                'multiple' => false,
	                'std'      => 'standard',
	                'desc'     => __( 'Choose the type of header that is shown on this post. NOTE: The naked options are only possible when you have the fancy heading enabled, or the media display below set to "Full Width with Title Overlay".', 'swiftframework' ),
	            ),
	            // FULL WIDTH MEDIA
	            array(
	                'name'     => __( 'Media Display', 'swiftframework' ),
	    ...
	    $meta_boxes[] = array(
	        ...
	        'fields'  => array(
	            ...
	            // Pin Modal Text
				array(
					'name' => __('Pin Modal Text', 'swiftframework'),
					'id' => $prefix . 'directory_pin_modal_text',
					'desc' => __('Enter the text of the Pin Modal.', 'swiftframework'),
					'type' => 'textarea',
					'std'  => '',
					'cols' => '40',
					'rows' => '4',  
		...
		$cardinal_meta_boxes = apply_filters( 'add_cardinal_meta_boxes', $meta_boxes );
		$meta_boxes = array_merge( $meta_boxes, $cardinal_meta_boxes );
