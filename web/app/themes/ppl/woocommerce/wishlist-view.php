...
?>
	...
	<div class="my-account-left">
		...
		<h4 class="lined-heading"><span><?php _e("My Account", 'atelier'); ?></span></h4>
		<ul class="nav my-account-nav">
			<?php if( is_user_logged_in() ) { ?>
			<li><a href="<?php echo esc_url($myaccount_page_url); ?>"><?php _e("Back to my account", 'atelier'); ?></a></li>
			<?php } else { ?>
			<li><a href="<?php echo esc_url($shop_page_url); ?>"><?php _e("Shop", 'atelier'); ?></a></li>
			<li><a href="<?php echo esc_url($myaccount_page_url); ?>"><?php _e("Create Account / Login", 'atelier'); ?></a></li>
			<?php } ?>
		</ul>
				...
				<table class="shop_table cart wishlist_table" data-pagination="<?php echo esc_attr( $pagination )?>" data-per-page="<?php echo esc_attr( $per_page )?>" data-page="<?php echo esc_attr( $current_page )?>" data-id="<?php echo esc_attr($wishlist_id); ?>" data-token="<?php echo esc_attr($wishlist_token); ?>">
			        ...
			        <tr>
			            ...
			            <th class="product-name">
			                <span class="nobr"><?php echo apply_filters( 'yith_wcwl_wishlist_view_name_heading', __( 'Product Name', 'atelier' ) ) ?></span>
			            </th>
			            ...
			            <?php if( $show_price ) : ?>
			                ...
			                <th class="product-price">
			                    <span class="nobr">
			                        <?php echo apply_filters( 'yith_wcwl_wishlist_view_price_heading', __( 'Unit Price', 'atelier' ) ) ?>
			                    </span>
			                </th>
			            ...
			            <?php if( $show_stock_status ) : ?>
			                ...
			                <th class="product-stock-status">
			                    <span class="nobr">
			                        <?php echo apply_filters( 'yith_wcwl_wishlist_view_stock_heading', __( 'Stock Status', 'atelier' ) ) ?>
			                    </span>
			                </th>
