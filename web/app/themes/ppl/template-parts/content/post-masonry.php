...
<div class="details-wrap">
	...
	<?php if ( $show_details == "yes" ) { ?>
	        <?php echo sf_get_post_details($post_id); ?>
	        <div class="comments-likes">
	        <?php if ( comments_open() ) { ?>
	            <div class="comments-wrapper"><a href="' . $post_permalink . '#comment-area"><?php echo $comments_icon; ?><span><?php echo $post_comments; ?></span></a></div>
	        <?php } ?>
	
	        <?php if ( function_exists( 'lip_love_it_link' ) ) {
	            echo lip_love_it_link( $postID, false );
	        } ?>
	        </div>
