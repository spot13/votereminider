    ...
    */
    ...
    if ( ! function_exists( 'sf_product_items' ) ) {
        function sf_product_items( $atts ) {
            ...
            global $woocommerce, $woocommerce_loop, $sf_sidebar_config, $sf_carouselID, $sf_options, $sf_product_multimasonry, $sf_product_display_type, $sf_product_display_layout;
            ...
            if ( $display_type != "" ) {
            	...
            	$sf_product_display_type = $display_type;
            }
