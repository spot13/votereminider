    ...
    if ( ! function_exists( 'sf_directory' ) ) {
        function sf_directory() {
            ...
            foreach ( $search_results as $result ) {
                ...
                $directory_item["pin_title"]   = '<a href="'. get_permalink( $result->ID ) .'">' . $result->post_title . '</a>';
                ...
                if ( $locations ) {
                 ...
                 // Use Pin Modal text field if it has any content
                 if( sf_get_post_meta( $result->ID, 'sf_directory_pin_modal_text', true ) ) {
                    $content  = sf_get_post_meta( $result->ID, 'sf_directory_pin_modal_text', true );
                 }
...
// Use Pin Modal text field if it has any content
                ...
                if ( !$pin_img_url ) {
                     //Get default Map Pin image if there isn't     
                     $directory_item["pin_logo_url"]    = $sf_options['default_directory_map_pin'];
                } else {
