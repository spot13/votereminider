<?php
        ...
        public function contentAdmin($atts, $content)
        {
            ...
            if (isset($this->settings['params'])) {
                ...
                if (isset($this->settings["custom_markup"]) && $this->settings["custom_markup"] != '') {
                    ...
                    } elseif ($content == '' && isset($this->settings["default_content"]) && $this->settings["default_content"] != '') {
   ...
   ---------------------------------------------------------- */
        public function getColumnControls($controls, $responsive_vis)
        {
            ...
            } elseif ($controls == 'edit_popup_delete') {
                return $column_controls_edit_popup_delete;
            } elseif ($controls == 'edit_delete') {
                return $column_controls_edit_delete;
            } elseif ($controls == 'size_delete') {
                return $column_controls_size_delete;
            } elseif ($controls == 'popup_delete') {
                return $column_controls_popup_delete;
            } elseif ($controls == 'column') {
                return $column_controls_full_col;
            } elseif ($controls == 'delete_edit') {
       ...
       ---------------------------------------------------------- */
        ...
        public function getResponsiveIndicatorHtml($value)
        {
            ...
            } elseif ($value == "hidden-lg_hidden-md_hidden-sm") {
            ...
            } elseif ($value == "hidden-lg_hidden-md_hidden-xs") {
            ...
            } elseif ($value == "hidden-xs_hidden-sm") {
    ...
    abstract class SwiftPageBuilderShortcode_UniversalAdmin extends SwiftPageBuilderShortcode
    {
        ...
        protected function singleParamEditForm($param, $param_value)
        {
            ...
            } elseif (isset($param['param_type']) &&  $param['param_type'] == 'css-field') {
                $margin = "0";
                $border = "0";
                $padding = "0";
            ...
            // Textfield - input
            } elseif ($param['type'] == 'textfield_html') {
                $value = __($param_value, 'swift-framework-plugin');
            ...
            elseif ($param['type'] == 'select-multiple') {
            ...
            elseif ($param['type'] == 'select-multiple-id') {
            ...
            elseif ($param['type'] == 'textarea_encoded') {
            ...
            elseif ($param['type'] == 'textarea_html') {
                $param_line .= $this->getTinyHtmlTextArea($param_value, $param);
            } // Checkboxes with post types
            elseif ($param['type'] == 'posttypes') {
            ...
            elseif ($param['type'] == 'exploded_textarea') {
            ...
            elseif ($param['type'] == 'textarea_raw_html') {
            ...
            elseif ($param['type'] == 'attach_images') {
            ...
            } elseif ($param['type'] == 'attach_image') {
                // TODO: More native way
            ...
            elseif ($param['type'] == 'widgetised_sidebars') {
        ...
        protected function getTinyHtmlTextArea($param_value, $param = array())
        {
            $param_line = '';
