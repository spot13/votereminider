...
= 2.7.32 =
* GENERAL: PHP compatibility fixes

= 2.7.31 =
* BACKEND: Fix issue with auto-update

= 2.7.30 =
* BACKEND: Fix JS issue previous version

= 2.7.29 =
* BACKEND: Fix issue previous version

= 2.7.28 =
* BACKEND: Fix issue with editor in SPB elements
* BACKEND: Update updater framework

= 2.7.27 =
* BACKEND: Fixed drag & drop issue with SPB *

= 2.7.26 =
* GENERAL: Fix outdated jQuery UI issue *
* BACKEND: Fixed issue with page builder in Firefox *

= 2.7.25 =
* GENERAL: Fix update issue *

= 2.7.24 =
* GENERAL: Theme Options CSS fix *

= 2.7.23 =
* GENERAL: WP 5.6 support *

= 2.7.22 =
* FRONTEND: Fix deprecated jQuery functions *

= 2.7.21 =
* BACKEND: Fix issue with page builder element toggles not saving *

= 2.7.20 =
* GENERAL: Updated to provide support for WordPress 5.5 changes *

= 2.7.19 =
* GENERAL: Updated Instagram Auth for new API requirements *
* FRONTEND: Fixed issue with header calculation with swift slider *
* FRONTEND: Fixed issue with icon output *
* BACKEND: Fixed issue where you were unable to edit an accordion title after adding a new one *
* BACKEND: Updated Redux Framework *

= 2.7.18 =
* GENERAL: Updated Font Awesome to v5.10.1 *
* FRONTEND: Fixed issue with foreign character tab titles *

= 2.7.17 =
* GENERAL: Fixed issue with Instagram Auth *

= 2.7.16 =
* GENERAL: Theme compatibility *

= 2.7.15 =
* GENERAL: Fixed issue where error would occur when SPB disabled *
* GENERAL: Fixed undefined function issue *

= 2.7.14 =
* GENERAL: Extra theme compatibility functions *
* GENERAL: Fixed issue with missing resize function *
* FRONTEND: Fixed missing team hover icon *
* FRONTEND: Fixed JS error *

= 2.7.13 =
* GENERAL: Extra theme compatibility functions *

= 2.7.12 =
* GENERAL: Fixed error with theme update compatibility *
* FRONTEND: Fixed missing team member icons *

= 2.7.0 =
* GENERAL: Compatibility functions for upcoming theme updates *
* FRONTEND: Fixed issue with promo bar display *
* FRONTEND: Fixed conflict with Swift Slider & plugins that use Swiper *


= 2.6.18 =
* REVERT FIX - FRONTEND: Fixed cross browser issue with column background display


= 2.6.17 =
* FRONTEND: Fixed issue with Team element social icon output
* FRONTEND: Fixed cross browser issue with column background display
* BACKEND: Fixed issue with Gravity Forms element option not saving state correctly


= 2.6.16 =
* BACKEND: Fixed "wrong post type" error when saving drafts in certain situations *


= 2.6.15 =
* BACKEND: Fixed missing SF Widgets *


= 2.6.14 =
* FRONTEND: Fixed issue with Team AJAX loading *
* FRONTEND: Add to cart shortcode button text now filterable *
* BACKEND: Fixed SPB loading issue with older WP versions *
* BACKEND: Fixed pre-built template loading *


= 2.6.13 =
* BACKEND: Removed custom fonts include that was causing errors *


= 2.6.12 =
* FRONTEND: Fixed further icon issues *
* BACKEND: Fixed issue with saved templates not outputting *	


= 2.6.11 =
** IMPORTANT - We have added a toggle option to the options panel to disable Gutenberg in order to allow the page builder to continue functioning **
* FRONTEND: Fixed column equal height issue
* FRONTEND: Fixed issue with Instagram widget output
* BACKEND: Fixed missing minizime/expand icons for rows in the page builder
* BACKEND: Fixed issue with saved items not loading


= 2.6.1 =
* FRONTEND: Font Awesome output fix for theme's not yet updated to Font Awesome v5

= 2.6.0 =
* FRONTEND: Updated Font Awesome to v5.2.0
* FRONTEND: Fixed issue with background video not playing on mobile
* FRONTEND: Swift Slider fixes
* FRONTEND: Page Builder element styling fixes
* GENERAL: Widgets now part of Swift Framework for upcoming theme updates. If you are missing any updates, please re-add them to your sidebar in Appearance > Widgets
